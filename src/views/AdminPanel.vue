...
const initiAsignaciones = {
    ...
    date_assignment_prev: { name: 'Fecha Asignacion Prevencion', order: 8, modified: false, lastCol: '' },
...
const initDB = {
    ...
    business_location: { name: 'Localidad', order: 4, modified: false, lastCol: '' },
    ...
    date_period: { name: 'periodo', order: 10, modified: false, lastCol: '' },
    ...
    audit_group: { name: 'Grupo Auditor', order: 37, modified: false, lastCol: '' },
